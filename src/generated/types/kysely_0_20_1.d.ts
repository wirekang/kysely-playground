...
declare type ColumnDataTypeNode = DataTypeNode | RawNode;
...
declare type AlterTableNodeProps = Omit<AlterTableNode, 'kind' | 'table'>;
...
declare const CreateTableNode: Readonly<{
    ...
    cloneWithFrontModifier(createTable: CreateTableNode, modifier: RawNode): CreateTableNode;
    cloneWithEndModifier(createTable: CreateTableNode, modifier: RawNode): CreateTableNode;
...
declare type AliasNodeChild = ColumnNode | ReferenceNode | TableNode | SelectQueryNode | RawNode;
...
declare const OPERATORS: readonly ["=", "==", "!=", "<>", ">", ">=", "<", "<=", "in", "not in", "is", "is not", "like", "not like", "ilike", "not ilike", "@>", "<@", "?", "?", "?&", "!<", "!>", "<=>", "!~", "~", "~*", "!~*", "exists", "not exists", "&&", "||", "@@", "@@@", "!!", "<->"];
declare type Operator = ArrayItemType<typeof OPERATORS>;
...
declare type FilterOperatorNode = OperatorNode | RawNode;
interface FilterNode extends OperationNode {
 ...
 * @internal
 */
declare const FilterNode: Readonly<{
...
declare type ReferenceExpressionNode = ColumnNode | ReferenceNode | SelectQueryNode | RawNode;
declare type ValueExpressionNode = ValueNode | ValueListNode | PrimitiveValueListNode | ReferenceExpressionNode;
declare type TableExpressionNode = TableNode | AliasNode;
declare type FilterExpressionNode = FilterNode | AndNode | OrNode | ParensNode | RawNode;
...
declare const FromNode: Readonly<{
    ...
    cloneWithFroms(from: FromNode, froms: ReadonlyArray<TableExpressionNode>): FromNode;
}>;
...
declare const GroupByNode: Readonly<{
    ...
    cloneWithItems(orderBy: GroupByNode, items: ReadonlyArray<GroupByItemNode>): GroupByNode;
}>;
...
declare const HavingNode: Readonly<{
    ...
    cloneWithFilter(havingNode: HavingNode, op: 'And' | 'Or', filter: FilterExpressionNode): HavingNode;
}>;
...
declare const OnNode: Readonly<{
    ...
    cloneWithFilter(onNode: OnNode, op: 'And' | 'Or', filter: FilterExpressionNode): OnNode;
}>;

declare type JoinTableNode = TableNode | AliasNode;
...
declare const JoinNode: Readonly<{
    ...
    createWithOn(joinType: JoinType, table: JoinTableNode, on: FilterExpressionNode): JoinNode;
...
declare const OrderByItemNode: Readonly<{
    ...
    create(orderBy: ReferenceExpressionNode, direction?: RawNode): OrderByItemNode;
}>;
...
declare type SelectionNodeChild = ColumnNode | ReferenceNode | AliasNode | SelectAllNode;
...
declare const WhereNode: Readonly<{
    ...
    cloneWithFilter(whereNode: WhereNode, op: 'And' | 'Or', filter: FilterExpressionNode): WhereNode;
}>;
...
interface Explainable {
    explain<O extends Record<string, any> = Record<string, any>>(format?: ExplainFormat, options?: AnyRawBuilder): Promise<O[]>;
}
...
declare const OnConflictNode: Readonly<{
    ...
    cloneWithIndexWhere(node: OnConflictNode, filter: FilterExpressionNode): OnConflictNode;
    cloneWithIndexOrWhere(node: OnConflictNode, filter: FilterExpressionNode): OnConflictNode;
    cloneWithUpdateWhere(node: OnConflictNode, filter: FilterExpressionNode): OnConflictNode;
    cloneWithUpdateOrWhere(node: OnConflictNode, filter: FilterExpressionNode): OnConflictNode;
}>;
...
declare const UpdateQueryNode: Readonly<{
    ...
    cloneWithFromItems(updateQuery: UpdateQueryNode, fromItems: ReadonlyArray<TableExpressionNode>): UpdateQueryNode;
...
declare const CommonTableExpressionNode: Readonly<{
    ...
    create(name: CommonTableExpressionNameNode, expression: QueryNode | RawNode): CommonTableExpressionNode;
}>;
...
declare type UnionExpressionNode = SelectQueryNode | RawNode;
interface UnionNode extends OperationNode {
 ...
 * @internal
 */
declare const UnionNode: Readonly<{
...
declare const SelectQueryNode: Readonly<{
    ...
    cloneWithUnion(selectNode: SelectQueryNode, union: UnionNode): SelectQueryNode;
    cloneWithExplain(selectNode: SelectQueryNode, explain: ExplainNode): SelectQueryNode;
}>;

declare type ListNodeItem = ValueNode | ReferenceNode | SelectQueryNode | RawNode;
 ...
 */
declare class RawBuilder<O = unknown> implements OperationNodeSource {
    #private;
 ...
 */
declare class AliasedRawBuilder<O = unknown, A extends string = never> implements OperationNodeSource {
    #private;
    /**
     * @private
     *
...
declare type ComplexExpression<DB, TB extends keyof DB, V = any> = AnySelectQueryBuilder | SelectQueryBuilderFactory<DB, TB> | RawBuilder<V> | RawBuilderFactory<DB, TB>;
declare type AliasedComplexExpression<DB, TB extends keyof DB> = AnyAliasedQueryBuilder | AliasedQueryBuilderFactory<DB, TB> | AnyAliasedRawBuilder | AliasedRawBuilderFactory<DB, TB>;

declare type TableExpression<DB, TB extends keyof DB> = TableReference<DB> | AliasedComplexExpression<DB, TB>;
declare type TableExpressionOrList<DB, TB extends keyof DB> = TableExpression<DB, TB> | ReadonlyArray<TableExpression<DB, TB>>;
declare type TableReference<DB> = AnyAliasedTable<DB> | AnyTable<DB> | AnyAliasedRawBuilder;
...
declare type ReferenceExpression<DB, TB extends keyof DB> = StringReference<DB, TB> | DynamicReferenceBuilder<any> | ComplexExpression<DB, TB>;
...
declare type ValueExpression<DB, TB extends keyof DB, V> = V | ComplexExpression<DB, TB, V>;
...
interface WhereInterface<DB, TB extends keyof DB> {
     ...
     * ```
     */
    where<RE extends ReferenceExpression<DB, TB>>(lhs: RE, op: FilterOperator, rhs: FilterValueExpressionOrList<DB, TB, RE>): WhereInterface<DB, TB>;
     ...
     * from "person"
     */
    whereRef(lhs: ReferenceExpression<DB, TB>, op: FilterOperator, rhs: ReferenceExpression<DB, TB>): WhereInterface<DB, TB>;
    /**
     ...
     * ```
     */
    orWhere<RE extends ReferenceExpression<DB, TB>>(lhs: RE, op: FilterOperator, rhs: FilterValueExpressionOrList<DB, TB, RE>): WhereInterface<DB, TB>;
     ...
     */
    orWhereRef(lhs: ReferenceExpression<DB, TB>, op: FilterOperator, rhs: ReferenceExpression<DB, TB>): WhereInterface<DB, TB>;
    /**
...
interface HavingInterface<DB, TB extends keyof DB> {
     ...
     */
    having<RE extends ReferenceExpression<DB, TB>>(lhs: RE, op: FilterOperator, rhs: FilterValueExpressionOrList<DB, TB, RE>): HavingInterface<DB, TB>;
     ...
     * instead of a `where` statement.
     */
    havingRef(lhs: ReferenceExpression<DB, TB>, op: FilterOperator, rhs: ReferenceExpression<DB, TB>): HavingInterface<DB, TB>;
    /**
     * Just like {@link WhereInterface.orWhere | orWhere} but adds a `having` statement
     * instead of a `where` statement.
     */
    orHaving<RE extends ReferenceExpression<DB, TB>>(lhs: RE, op: FilterOperator, rhs: FilterValueExpressionOrList<DB, TB, RE>): HavingInterface<DB, TB>;
     ...
     * instead of a `where` statement.
     */
    orHavingRef(lhs: ReferenceExpression<DB, TB>, op: FilterOperator, rhs: ReferenceExpression<DB, TB>): HavingInterface<DB, TB>;
    /**
...
declare type FilterValueExpression<DB, TB extends keyof DB, RE> = ValueExpression<DB, TB, ExtractTypeFromReferenceExpression<DB, TB, RE>>;
declare type FilterValueExpressionOrList<DB, TB extends keyof DB, RE> = ValueExpressionOrList<DB, TB, ExtractTypeFromReferenceExpression<DB, TB, RE>>;
declare type ExistsExpression<DB, TB extends keyof DB> = ComplexExpression<DB, TB, any>;
...
declare type FilterOperator = Operator | AnyRawBuilder;
...
declare type SelectExpression<DB, TB extends keyof DB> = AnyAliasedColumnWithTable<DB, TB> | AnyAliasedColumn<DB, TB> | AnyColumnWithTable<DB, TB> | AnyColumn<DB, TB> | DynamicReferenceBuilder<any> | AliasedComplexExpression<DB, TB>;
...
declare type OrderByDirectionExpression = OrderByDirection | AnyRawBuilder;

interface Compilable {
    compile(): CompiledQuery;
}

declare type UnionExpression<DB, O> = SelectQueryBuilder<DB, any, O> | RawBuilder<O>;
...
declare class SelectQueryBuilder<DB, TB extends keyof DB, O> implements WhereInterface<DB, TB>, HavingInterface<DB, TB>, OperationNodeSource, Compilable, Explainable {
    #private;
     ...
     * ```
     */
    groupBy(groupBy: ReadonlyArray<ReferenceExpression<DB, TB>>): SelectQueryBuilder<DB, TB, O>;
 ...
 */
declare class AliasedQueryBuilder<DB, TB extends keyof DB, O = undefined, A extends string = never> {
    #private;
...
declare type SelectQueryBuilderWithInnerJoin<DB, TB extends keyof DB, O, TE extends TableExpression<DB, TB>> = TE extends `${infer T} as ${infer A}` ? T extends keyof DB ? InnerJoinedBuilder$2<DB, TB, O, A, DB[T]> : never : TE extends keyof DB ? SelectQueryBuilder<DB, TB | TE, O> : TE extends AliasedQueryBuilder<any, any, infer QO, infer QA> ? InnerJoinedBuilder$2<DB, TB, O, QA, QO> : TE extends (qb: any) => AliasedQueryBuilder<any, any, infer QO, infer QA> ? InnerJoinedBuilder$2<DB, TB, O, QA, QO> : TE extends AliasedRawBuilder<infer RO, infer RA> ? InnerJoinedBuilder$2<DB, TB, O, RA, RO> : TE extends (qb: any) => AliasedRawBuilder<infer RO, infer RA> ? InnerJoinedBuilder$2<DB, TB, O, RA, RO> : never;
...
declare type SelectQueryBuilderWithLeftJoin<DB, TB extends keyof DB, O, TE extends TableExpression<DB, TB>> = TE extends `${infer T} as ${infer A}` ? T extends keyof DB ? LeftJoinedBuilder$2<DB, TB, O, A, DB[T]> : never : TE extends keyof DB ? LeftJoinedBuilder$2<DB, TB, O, TE, DB[TE]> : TE extends AliasedQueryBuilder<any, any, infer QO, infer QA> ? LeftJoinedBuilder$2<DB, TB, O, QA, QO> : TE extends (qb: any) => AliasedQueryBuilder<any, any, infer QO, infer QA> ? LeftJoinedBuilder$2<DB, TB, O, QA, QO> : TE extends AliasedRawBuilder<infer RO, infer RA> ? LeftJoinedBuilder$2<DB, TB, O, RA, RO> : TE extends (qb: any) => AliasedRawBuilder<infer RO, infer RA> ? LeftJoinedBuilder$2<DB, TB, O, RA, RO> : never;
...
declare type SelectQueryBuilderWithRightJoin<DB, TB extends keyof DB, O, TE extends TableExpression<DB, TB>> = TE extends `${infer T} as ${infer A}` ? T extends keyof DB ? RightJoinedBuilder$2<DB, TB, O, A, DB[T]> : never : TE extends keyof DB ? RightJoinedBuilder$2<DB, TB, O, TE, DB[TE]> : TE extends AliasedQueryBuilder<any, any, infer QO, infer QA> ? RightJoinedBuilder$2<DB, TB, O, QA, QO> : TE extends (qb: any) => AliasedQueryBuilder<any, any, infer QO, infer QA> ? RightJoinedBuilder$2<DB, TB, O, QA, QO> : TE extends AliasedRawBuilder<infer RO, infer RA> ? RightJoinedBuilder$2<DB, TB, O, RA, RO> : TE extends (qb: any) => AliasedRawBuilder<infer RO, infer RA> ? RightJoinedBuilder$2<DB, TB, O, RA, RO> : never;
...
declare type SelectQueryBuilderWithFullJoin<DB, TB extends keyof DB, O, TE extends TableExpression<DB, TB>> = TE extends `${infer T} as ${infer A}` ? T extends keyof DB ? OuterJoinedBuilder$2<DB, TB, O, A, DB[T]> : never : TE extends keyof DB ? OuterJoinedBuilder$2<DB, TB, O, TE, DB[TE]> : TE extends AliasedQueryBuilder<any, any, infer QO, infer QA> ? OuterJoinedBuilder$2<DB, TB, O, QA, QO> : TE extends (qb: any) => AliasedQueryBuilder<any, any, infer QO, infer QA> ? OuterJoinedBuilder$2<DB, TB, O, QA, QO> : TE extends AliasedRawBuilder<infer RO, infer RA> ? OuterJoinedBuilder$2<DB, TB, O, RA, RO> : TE extends (qb: any) => AliasedRawBuilder<infer RO, infer RA> ? OuterJoinedBuilder$2<DB, TB, O, RA, RO> : never;
 ...
 * ```
 */
declare class FunctionBuilder<DB, TB extends keyof DB> {
    #private;
    constructor();
    /**
     ...
     * ```
     */
    max<C extends StringReference<DB, TB>>(column: C): RawBuilder<ExtractTypeFromReferenceExpression<DB, TB, C>>;
    /**
     ...
     *
     */
    min<C extends StringReference<DB, TB>>(column: C): RawBuilder<ExtractTypeFromReferenceExpression<DB, TB, C>>;
    /**
     ...
     * ```
     */
    avg<O extends number | string, C extends StringReference<DB, TB> = StringReference<DB, TB>>(column: C): RawBuilder<O>;
    /**
     ...
     * ```
     */
    sum<O extends number | string | bigint, C extends StringReference<DB, TB> = StringReference<DB, TB>>(column: C): RawBuilder<O>;
    /**
     ...
     * ```
     */
    count<O extends number | string | bigint, C extends StringReference<DB, TB> = StringReference<DB, TB>>(column: C): RawBuilder<O>;
}
...
declare type AnyAliasedQueryBuilder = AliasedQueryBuilder<any, any, any, any>;
declare type AnyRawBuilder = RawBuilder<any>;
declare type AnyAliasedRawBuilder = AliasedRawBuilder<any, any>;
declare type SelectQueryBuilderFactory<DB, TB extends keyof DB> = (qb: ExpressionBuilder<DB, TB>) => AnySelectQueryBuilder;
declare type AliasedQueryBuilderFactory<DB, TB extends keyof DB> = (qb: ExpressionBuilder<DB, TB>) => AnyAliasedQueryBuilder;
declare type RawBuilderFactory<DB, TB extends keyof DB> = (qb: ExpressionBuilder<DB, TB>) => AnyRawBuilder;
declare type AliasedRawBuilderFactory<DB, TB extends keyof DB> = (qb: ExpressionBuilder<DB, TB>) => AnyAliasedRawBuilder;
...
declare type DefaultValueExpression = unknown | RawBuilder;
...
declare class ColumnDefinitionBuilder implements ColumnDefinitionBuilderInterface, OperationNodeSource {
    #private;
...
declare type DataTypeExpression = ColumnDataType | AnyRawBuilder;
...
interface AlterColumnBuilderProps extends AlterTableBuilderProps {
...
declare class AlterTableAddColumnBuilder implements ColumnDefinitionBuilderInterface, OperationNodeSource, Compilable {
    #private;
...
interface AlterTableAddColumnBuilderProps extends AlterTableBuilderProps {
    readonly columnBuilder: ColumnDefinitionBuilder;
}
declare type AlterTableAddColumnBuilderCallback = (builder: AlterTableAddColumnBuilder) => AlterTableAddColumnBuilder;
declare class AlterTableModifyColumnBuilder implements ColumnDefinitionBuilderInterface, OperationNodeSource, Compilable {
    #private;
...
interface AlterTableModifyColumnBuilderProps extends AlterTableBuilderProps {
    readonly columnBuilder: ColumnDefinitionBuilder;
}
...
declare class InsertQueryBuilder<DB, TB extends keyof DB, O> implements ReturningInterface<DB, TB, O>, OperationNodeSource, Compilable, Explainable {
    #private;
     ...
     * ```
     */
    expression(expression: ComplexExpression<DB, TB>): InsertQueryBuilder<DB, TB, O>;
    /**
...
declare class DeleteQueryBuilder<DB, TB extends keyof DB, O> implements WhereInterface<DB, TB>, ReturningInterface<DB, TB, O>, OperationNodeSource, Compilable, Explainable {
    #private;
...
declare type DeleteQueryBuilderWithInnerJoin<DB, TB extends keyof DB, O, TE extends TableExpression<DB, TB>> = TE extends `${infer T} as ${infer A}` ? T extends keyof DB ? InnerJoinedBuilder$1<DB, TB, O, A, DB[T]> : never : TE extends keyof DB ? DeleteQueryBuilder<DB, TB | TE, O> : TE extends AliasedQueryBuilder<any, any, infer QO, infer QA> ? InnerJoinedBuilder$1<DB, TB, O, QA, QO> : TE extends (qb: any) => AliasedQueryBuilder<any, any, infer QO, infer QA> ? InnerJoinedBuilder$1<DB, TB, O, QA, QO> : TE extends AliasedRawBuilder<infer RO, infer RA> ? InnerJoinedBuilder$1<DB, TB, O, RA, RO> : TE extends (qb: any) => AliasedRawBuilder<infer RO, infer RA> ? InnerJoinedBuilder$1<DB, TB, O, RA, RO> : never;
...
declare type DeleteQueryBuilderWithLeftJoin<DB, TB extends keyof DB, O, TE extends TableExpression<DB, TB>> = TE extends `${infer T} as ${infer A}` ? T extends keyof DB ? LeftJoinedBuilder$1<DB, TB, O, A, DB[T]> : never : TE extends keyof DB ? LeftJoinedBuilder$1<DB, TB, O, TE, DB[TE]> : TE extends AliasedQueryBuilder<any, any, infer QO, infer QA> ? LeftJoinedBuilder$1<DB, TB, O, QA, QO> : TE extends (qb: any) => AliasedQueryBuilder<any, any, infer QO, infer QA> ? LeftJoinedBuilder$1<DB, TB, O, QA, QO> : TE extends AliasedRawBuilder<infer RO, infer RA> ? LeftJoinedBuilder$1<DB, TB, O, RA, RO> : TE extends (qb: any) => AliasedRawBuilder<infer RO, infer RA> ? LeftJoinedBuilder$1<DB, TB, O, RA, RO> : never;
...
declare type DeleteQueryBuilderWithRightJoin<DB, TB extends keyof DB, O, TE extends TableExpression<DB, TB>> = TE extends `${infer T} as ${infer A}` ? T extends keyof DB ? RightJoinedBuilder$1<DB, TB, O, A, DB[T]> : never : TE extends keyof DB ? RightJoinedBuilder$1<DB, TB, O, TE, DB[TE]> : TE extends AliasedQueryBuilder<any, any, infer QO, infer QA> ? RightJoinedBuilder$1<DB, TB, O, QA, QO> : TE extends (qb: any) => AliasedQueryBuilder<any, any, infer QO, infer QA> ? RightJoinedBuilder$1<DB, TB, O, QA, QO> : TE extends AliasedRawBuilder<infer RO, infer RA> ? RightJoinedBuilder$1<DB, TB, O, RA, RO> : TE extends (qb: any) => AliasedRawBuilder<infer RO, infer RA> ? RightJoinedBuilder$1<DB, TB, O, RA, RO> : never;
...
declare type DeleteQueryBuilderWithFullJoin<DB, TB extends keyof DB, O, TE extends TableExpression<DB, TB>> = TE extends `${infer T} as ${infer A}` ? T extends keyof DB ? OuterJoinedBuilder$1<DB, TB, O, A, DB[T]> : never : TE extends keyof DB ? OuterJoinedBuilder$1<DB, TB, O, TE, DB[TE]> : TE extends AliasedQueryBuilder<any, any, infer QO, infer QA> ? OuterJoinedBuilder$1<DB, TB, O, QA, QO> : TE extends (qb: any) => AliasedQueryBuilder<any, any, infer QO, infer QA> ? OuterJoinedBuilder$1<DB, TB, O, QA, QO> : TE extends AliasedRawBuilder<infer RO, infer RA> ? OuterJoinedBuilder$1<DB, TB, O, RA, RO> : TE extends (qb: any) => AliasedRawBuilder<infer RO, infer RA> ? OuterJoinedBuilder$1<DB, TB, O, RA, RO> : never;
...
declare class UpdateQueryBuilder<DB, UT extends keyof DB, TB extends keyof DB, O> implements WhereInterface<DB, TB>, ReturningInterface<DB, TB, O>, OperationNodeSource, Compilable, Explainable {
    #private;
     ...
     * ```
     */
    where<RE extends ReferenceExpression<DB, TB>>(lhs: RE, op: FilterOperator, rhs: FilterValueExpressionOrList<DB, TB, RE>): UpdateQueryBuilder<DB, UT, TB, O>;
     ...
     * from "person"
     */
    whereRef(lhs: ReferenceExpression<DB, TB>, op: FilterOperator, rhs: ReferenceExpression<DB, TB>): UpdateQueryBuilder<DB, UT, TB, O>;
    /**
     * Adds an `or where` clause to the query. Otherwise works just like {@link where}.
     *
     * It's often necessary to wrap `or where` clauses in parentheses to control
     ...
     * ```
     */
    orWhere<RE extends ReferenceExpression<DB, TB>>(lhs: RE, op: FilterOperator, rhs: FilterValueExpressionOrList<DB, TB, RE>): UpdateQueryBuilder<DB, UT, TB, O>;
     ...
     * Also see {@link orWhere} and {@link where}.
     */
    orWhereRef(lhs: ReferenceExpression<DB, TB>, op: FilterOperator, rhs: ReferenceExpression<DB, TB>): UpdateQueryBuilder<DB, UT, TB, O>;
    /**
     * Adds a `where exists` clause to the query.
     *
     * You can either use a subquery or a raw {@link sql} snippet.
...
declare type UpdateQueryBuilderWithInnerJoin<DB, UT extends keyof DB, TB extends keyof DB, O, TE extends TableExpression<DB, TB>> = TE extends `${infer T} as ${infer A}` ? T extends keyof DB ? InnerJoinedBuilder<DB, UT, TB, O, A, DB[T]> : never : TE extends keyof DB ? UpdateQueryBuilder<DB, UT, TB | TE, O> : TE extends AliasedQueryBuilder<any, any, infer QO, infer QA> ? InnerJoinedBuilder<DB, UT, TB, O, QA, QO> : TE extends (qb: any) => AliasedQueryBuilder<any, any, infer QO, infer QA> ? InnerJoinedBuilder<DB, UT, TB, O, QA, QO> : TE extends AliasedRawBuilder<infer RO, infer RA> ? InnerJoinedBuilder<DB, UT, TB, O, RA, RO> : TE extends (qb: any) => AliasedRawBuilder<infer RO, infer RA> ? InnerJoinedBuilder<DB, UT, TB, O, RA, RO> : never;
...
declare type UpdateQueryBuilderWithLeftJoin<DB, UT extends keyof DB, TB extends keyof DB, O, TE extends TableExpression<DB, TB>> = TE extends `${infer T} as ${infer A}` ? T extends keyof DB ? LeftJoinedBuilder<DB, UT, TB, O, A, DB[T]> : never : TE extends keyof DB ? LeftJoinedBuilder<DB, UT, TB, O, TE, DB[TE]> : TE extends AliasedQueryBuilder<any, any, infer QO, infer QA> ? LeftJoinedBuilder<DB, UT, TB, O, QA, QO> : TE extends (qb: any) => AliasedQueryBuilder<any, any, infer QO, infer QA> ? LeftJoinedBuilder<DB, UT, TB, O, QA, QO> : TE extends AliasedRawBuilder<infer RO, infer RA> ? LeftJoinedBuilder<DB, UT, TB, O, RA, RO> : TE extends (qb: any) => AliasedRawBuilder<infer RO, infer RA> ? LeftJoinedBuilder<DB, UT, TB, O, RA, RO> : never;
...
declare type UpdateQueryBuilderWithRightJoin<DB, UT extends keyof DB, TB extends keyof DB, O, TE extends TableExpression<DB, TB>> = TE extends `${infer T} as ${infer A}` ? T extends keyof DB ? RightJoinedBuilder<DB, UT, TB, O, A, DB[T]> : never : TE extends keyof DB ? RightJoinedBuilder<DB, UT, TB, O, TE, DB[TE]> : TE extends AliasedQueryBuilder<any, any, infer QO, infer QA> ? RightJoinedBuilder<DB, UT, TB, O, QA, QO> : TE extends (qb: any) => AliasedQueryBuilder<any, any, infer QO, infer QA> ? RightJoinedBuilder<DB, UT, TB, O, QA, QO> : TE extends AliasedRawBuilder<infer RO, infer RA> ? RightJoinedBuilder<DB, UT, TB, O, RA, RO> : TE extends (qb: any) => AliasedRawBuilder<infer RO, infer RA> ? RightJoinedBuilder<DB, UT, TB, O, RA, RO> : never;
...
declare type UpdateQueryBuilderWithFullJoin<DB, UT extends keyof DB, TB extends keyof DB, O, TE extends TableExpression<DB, TB>> = TE extends `${infer T} as ${infer A}` ? T extends keyof DB ? OuterJoinedBuilder<DB, UT, TB, O, A, DB[T]> : never : TE extends keyof DB ? OuterJoinedBuilder<DB, UT, TB, O, TE, DB[TE]> : TE extends AliasedQueryBuilder<any, any, infer QO, infer QA> ? OuterJoinedBuilder<DB, UT, TB, O, QA, QO> : TE extends (qb: any) => AliasedQueryBuilder<any, any, infer QO, infer QA> ? OuterJoinedBuilder<DB, UT, TB, O, QA, QO> : TE extends AliasedRawBuilder<infer RO, infer RA> ? OuterJoinedBuilder<DB, UT, TB, O, RA, RO> : TE extends (qb: any) => AliasedRawBuilder<infer RO, infer RA> ? OuterJoinedBuilder<DB, UT, TB, O, RA, RO> : never;
...
declare class DefaultQueryCompiler extends OperationNodeVisitor implements QueryCompiler {
    ...
    protected visitUnion(node: UnionNode): void;
...
declare type PostgresCursorConstructor = new <T>(sql: string, parameters: readonly unknown[]) => PostgresCursor<T>;
declare type PostgresCursor<T> = {
...
interface PostgresStreamOptions {
}
...
declare class OperationNodeTransformer {
    #private;
    protected readonly nodeStack: OperationNode[];
    readonly transformNode: <T extends OperationNode | undefined, U extends T | undefined = T>(node: U) => T;
...
export { AddColumnNode, AddConstraintNode, AliasNode, AliasNodeChild, AliasedQueryBuilder, AliasedRawBuilder, AlterColumnBuilder, AlterColumnBuilderProps, AlterColumnNode, AlterColumnNodeProps, AlterTableAddColumnBuilder, AlterTableAddColumnBuilderCallback, AlterTableAddColumnBuilderProps, AlterTableAddForeignKeyConstraintBuilder, AlterTableAddForeignKeyConstraintBuilderProps, AlterTableBuilder, AlterTableBuilderProps, AlterTableDropConstraintBuilder, AlterTableDropConstraintBuilderProps, AlterTableExecutor, AlterTableExecutorProps, AlterTableModifyColumnBuilder, AlterTableModifyColumnBuilderProps, AlterTableNode, AlterTableNodeProps, AndNode, AnyColumn, AnySelectQueryBuilder, CamelCasePlugin, CamelCasePluginOptions, CheckConstraintNode, ColumnBuilderCallback, ColumnDataType, ColumnDataTypeNode, ColumnDefinitionBuilder, ColumnDefinitionBuilderInterface, ColumnDefinitionNode, ColumnDefinitionNodeProps, ColumnMetadata, ColumnNode, ColumnType, ColumnUpdateNode, CommonTableExpressionNameNode, CommonTableExpressionNode, Compilable, CompiledQuery, ConnectionBuilder, ConnectionProvider, ConstraintNode, CreateIndexBuilder, CreateIndexBuilderProps, CreateIndexNode, CreateIndexNodeProps, CreateSchemaBuilder, CreateSchemaBuilderProps, CreateSchemaNode, CreateSchemaNodeParams, CreateTableBuilder, CreateTableBuilderProps, CreateTableNode, CreateTableNodeParams, CreateTypeBuilder, CreateTypeBuilderProps, CreateTypeNode, CreateTypeNodeParams, CreateViewBuilder, CreateViewBuilderProps, CreateViewNode, CreateViewNodeParams, DEFAULT_MIGRATION_LOCK_TABLE, DEFAULT_MIGRATION_TABLE, DataTypeNode, DataTypeParams, DatabaseConnection, DatabaseIntrospector, DatabaseMetadata, DatabaseMetadataOptions, DeduplicateJoinsPlugin, DefaultConnectionProvider, DefaultQueryCompiler, DefaultQueryExecutor, DefaultValueNode, DeleteQueryBuilder, DeleteQueryBuilderProps, DeleteQueryBuilderWithFullJoin, DeleteQueryBuilderWithInnerJoin, DeleteQueryBuilderWithLeftJoin, DeleteQueryBuilderWithRightJoin, DeleteQueryNode, DeleteResult, Dialect, DialectAdapter, DialectAdapterBase, Driver, DropColumnNode, DropConstraintNode, DropConstraintNodeProps, DropIndexBuilder, DropIndexBuilderProps, DropIndexNode, DropIndexNodeProps, DropSchemaBuilder, DropSchemaBuilderProps, DropSchemaNode, DropSchemaNodeParams, DropTableBuilder, DropTableBuilderProps, DropTableNode, DropTablexNodeParams, DropTypeBuilder, DropTypeBuilderProps, DropTypeNode, DropTypeNodeParams, DropViewBuilder, DropViewBuilderProps, DropViewNode, DropViewNodeParams, DummyDriver, DynamicModule, ErrorLogEvent, ExistsExpression, ExplainFormat, ExplainNode, Explainable, ExpressionBuilder, ExpressionBuilderProps, FileMigrationProvider, FileMigrationProviderFS, FileMigrationProviderPath, FileMigrationProviderProps, FilterExpressionNode, FilterNode, FilterOperator, FilterOperatorNode, FilterValueExpression, FilterValueExpressionOrList, FilterableQueryNode, ForeignKeyConstraintBuilder, ForeignKeyConstraintBuilderCallback, ForeignKeyConstraintBuilderInterface, ForeignKeyConstraintNode, ForeignKeyConstraintNodeProps, FromNode, FunctionBuilder, Generated, GeneratedAlways, GeneratedNode, GeneratedNodeParams, GroupByItemNode, GroupByNode, HavingInterface, HavingNode, IdentifierNode, IndexType, InsertObject, InsertQueryBuilder, InsertQueryBuilderProps, InsertQueryNode, InsertQueryNodeProps, InsertResult, InsertType, Insertable, IsolationLevel, JoinBuilder, JoinBuilderProps, JoinCallbackExpression, JoinNode, JoinReferenceExpression, JoinTableNode, JoinType, Kysely, KyselyConfig, KyselyPlugin, KyselyProps, LOG_LEVELS, LimitNode, ListNode, ListNodeItem, Log, LogConfig, LogEvent, LogLevel, Logger, MIGRATION_LOCK_ID, Migration, MigrationInfo, MigrationProvider, MigrationResult, MigrationResultSet, Migrator, MigratorProps, ModifyColumnNode, MutatingQueryNode, MutationObject, MysqlAdapter, MysqlDialect, MysqlDialectConfig, MysqlDriver, MysqlIntrospector, MysqlOkPacket, MysqlPool, MysqlPoolConnection, MysqlQueryCompiler, MysqlQueryResult, MysqlStream, MysqlStreamOptions, NOOP_QUERY_EXECUTOR, NO_MIGRATIONS, NoMigrations, NoResultError, NoResultErrorConstructor, NonNullableInsertKeys, NoopQueryExecutor, NullableInsertKeys, ON_COMMIT_ACTIONS, ON_MODIFY_FOREIGN_ACTIONS, OPERATORS, OffsetNode, OnCommitAction, OnConflictBuilder, OnConflictBuilderProps, OnConflictDatabase, OnConflictDoNothingBuilder, OnConflictNode, OnConflictNodeProps, OnConflictTables, OnConflictUpdateBuilder, OnDuplicateKeyNode, OnDuplicateKeyNodeProps, OnModifyForeignAction, OnNode, OperationNode, OperationNodeKind, OperationNodeSource, OperationNodeTransformer, OperationNodeVisitor, Operator, OperatorNode, OrNode, OrderByDirectionExpression, OrderByExpression, OrderByItemNode, OrderByNode, ParensNode, PluginTransformQueryArgs, PluginTransformResultArgs, PostgresAdapter, PostgresCursor, PostgresCursorConstructor, PostgresDialect, PostgresDialectConfig, PostgresDriver, PostgresIntrospector, PostgresPool, PostgresPoolClient, PostgresQueryCompiler, PostgresQueryResult, PostgresStream, PostgresStreamOptions, PrimaryConstraintNode, PrimaryKeyConstraintNode, PrimitiveValueListNode, QueryCompiler, QueryCreator, QueryCreatorProps, QueryExecutor, QueryExecutorProvider, QueryLogEvent, QueryNode, QueryResult, RawBuilder, RawBuilderProps, RawNode, ReferenceExpression, ReferenceExpressionNode, ReferenceExpressionOrList, ReferenceNode, ReferencesNode, RenameColumnNode, ReturningInterface, ReturningNode, RootOperationNode, SchemaMetadata, SchemaModule, SelectAllNode, SelectExpression, SelectExpressionOrList, SelectQueryBuilder, SelectQueryBuilderProps, SelectQueryBuilderWithFullJoin, SelectQueryBuilderWithInnerJoin, SelectQueryBuilderWithLeftJoin, SelectQueryBuilderWithRightJoin, SelectQueryNode, SelectType, Selectable, Selection, SelectionNode, SingleConnectionProvider, Sql, SqliteAdapter, SqliteDatabase, SqliteDialect, SqliteDialectConfig, SqliteDriver, SqliteIntrospector, SqliteQueryCompiler, SqliteStatement, TRANSACTION_ISOLATION_LEVELS, TableExpression, TableExpressionNode, TableExpressionOrList, TableMetadata, TableNode, Transaction, TransactionBuilder, TransactionSettings, UnionExpression, UnionExpressionNode, UnionNode, UniqueConstraintNode, UnknownRow, UpdateKeys, UpdateQueryBuilder, UpdateQueryBuilderProps, UpdateQueryBuilderWithFullJoin, UpdateQueryBuilderWithInnerJoin, UpdateQueryBuilderWithLeftJoin, UpdateQueryBuilderWithRightJoin, UpdateQueryNode, UpdateResult, UpdateType, UpdateValuesNode, Updateable, ValueExpression, ValueExpressionNode, ValueExpressionOrList, ValueListNode, ValueNode, ValuesItemNode, ValuesNode, WhereInterface, WhereNode, WithNode, WithNodeParams, WithSchemaPlugin, isKyselyProps, isOperationNodeSource, sql };
